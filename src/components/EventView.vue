      ...
      <div class="text-center flex justify-center items-center">
        <div class="mt-3 mb-3">
          ...
          <table class="table-auto w-screen">
            ...
            <tbody>
              <tr class="pa-3">
                <td class="pa-3">Seats without popcorn and drinks</td>
                <td class="pa-3">${{ formatCurrency(price_of_seats_without) }}</td>
                <td class="pa-3">
                  <select class="pa-3" id="" v-model="no_of_seats_without">
                    <option
                      class="pa-3 bg-dark"
              ...
              <tr class="pa-3">
                <td class="pa-3">Seats with popcorn and drinks</td>
                <td class="pa-3">${{ formatCurrency(price_of_seats_with) }}</td>
                <td class="pa-3">
                  <select class="pa-3" id="" v-model="no_of_seats_with">
                    <option
                      class="pa-3 bg-black"
                      v-for="(num, i) of quantityModel"
                      :key="i"
          ...
          <div class="m-3">
            ...
            <button
              ...
              class="bg-black text-white pa-3"
            >
              Book Now
            </button>
          </div>
        ...
        try {
          const res = await axios.post(`http://localhost:1337/api/tickets`, {
            data: {
              ...
              event: this.id,
              reference_number: 'string' + Math.random(),
            },
          });
          this.res = res.data;
